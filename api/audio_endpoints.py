...
async def validate_audio(file: UploadFile = File(...)):
    try:
        ...
        if isinstance(transcription, dict):
            ...
            raise HTTPException(status_code=400, detail="Unexpected dictionary response")
        validation_result = audio_controller.text_controller.validate_classification(transcription)
